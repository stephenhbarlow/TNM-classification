...
# Class to evaluate a multi-task multi-label classifier
class MultiLabelEvaluateModel(object):
    ...
    def eval(self):
        ...
        tnm_acc = accuracy_score(eval_dict['y_labels'][:, 0:3], eval_dict['preds'][:, 0:3])
        ...
        print(classification_report(eval_dict['y_labels'][:, 0], eval_dict['preds'][:, 0], digits=4))
        print(classification_report(eval_dict['y_labels'][:, 1], eval_dict['preds'][:, 1], digits=4))
